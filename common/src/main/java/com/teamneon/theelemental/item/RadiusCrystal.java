...
public class RadiusCrystal extends Item {

    public RadiusCrystal(Properties properties) {
        super(properties);
    }
    ...
    public Component getName(ItemStack stack) {
        ...
        int color = UtilityHelper.getMultiFadeColor(new int[]{0xffadce, 0xFFFFFF}, 2000);
        // 2. Return the name with the dynamic color applied
        return Component.translatable("item.theelemental.radius_crystal")
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, TooltipDisplay tooltipDisplay, Consumer<Component> tooltipAdder, TooltipFlag flag) {
        ...
        tooltipAdder.accept(Component.literal("Kingdom Upgrade")
                .withStyle(style -> style.withColor(0xde4080)));
        ...
        if (!Minecraft.getInstance().hasShiftDown()) {
            ...
            tooltipAdder.accept(Component.literal("• Increases the border radius of your kingdom").withStyle(ChatFormatting.DARK_GRAY));
        }
    }
