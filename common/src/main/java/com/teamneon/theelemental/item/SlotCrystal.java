...
public class SlotCrystal extends Item {

    public SlotCrystal(Properties properties) {
        super(properties);
    }
    ...
    public Component getName(ItemStack stack) {
        ...
        int color = UtilityHelper.getMultiFadeColor(new int[]{0x96f3ff, 0xFFFFFF}, 2000);
        // 2. Return the name with the dynamic color applied
        return Component.translatable("item.theelemental.slot_crystal")
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, TooltipDisplay tooltipDisplay, Consumer<Component> tooltipAdder, TooltipFlag flag) {
        ...
        tooltipAdder.accept(Component.literal("Kingdom Upgrade")
                .withStyle(style -> style.withColor(0x41c9dc)));
        ...
        if (!Minecraft.getInstance().hasShiftDown()) {
            ...
            tooltipAdder.accept(Component.literal("• Unlock more spell slots").withStyle(ChatFormatting.DARK_GRAY));
        }
    }
}